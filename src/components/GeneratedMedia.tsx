...
export const GeneratedMedia: React.FC<GeneratedMediaProps> = ({ url, type, alt }) => {
  return (
    <div className="mt-4 bg-theme-secondary/50 p-2 rounded-theme relative group">
      {type === 'image' ? (
      ...
      <a
        ...
        className="absolute bottom-4 right-4 bg-black/60 text-white p-2 rounded-full hover:bg-theme-accent transition-all opacity-0 group-hover:opacity-100"
