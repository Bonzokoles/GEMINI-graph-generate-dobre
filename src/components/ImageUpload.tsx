    ...
    <div className="w-full">
      ...
      {uploadedFile ? (
        <div className="relative group">
          <img src={uploadedFile.preview} alt="Preview" className="w-full rounded-theme object-contain max-h-80" />
          <button
            onClick={clearFile}
        ...
        <label
          ...
          className="flex justify-center w-full h-48 px-4 transition bg-theme-secondary/50 border-2 border-theme-secondary border-dashed rounded-theme appearance-none cursor-pointer hover:border-theme-accent focus:outline-none"
        >
          <span className="flex items-center space-x-2">
            <UploadCloud className="text-theme-text/60" />
            <span className="font-medium text-theme-text/60">
              Drop an image, or <span className="text-theme-accent-alt underline">browse</span>
            </span>
          </span>
